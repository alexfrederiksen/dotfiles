...
let s:bwc.lime = ['beee00', 154]

" Rose's dress in The Idiot's Lantern.
let s:bwc.dress = ['ff9eb8', 211]
let s:bwc.dress = ['f4dfc6', 222]
...
call s:HL('FoldColumn', 'mediumgravel', 'bg')
...
call s:HL('Special', 'saltwatertaffy', '', 'bold')
...
call s:HL('cIncluded', 'dirtyblonde', '', 'underline')
...
call s:HL('LspCxxHlSymNamespace',      'coffee', '', 'bold')
call s:HL('LspCxxHlSymMethod',         'orange', '', 'bold')
call s:HL('LspCxxHlSymFunction',       'orange', '', 'italic')
call s:HL('LspCxxHlSymLocalVariable',  'dress', '', 'none')
call s:HL('LspCxxHlSymParameter',      'dress', '', 'underline')
call s:HL('LspCxxHlSymVariable',       'dress', '', 'none')
call s:HL('LspCxxHlSymField',          'toffee', '', 'none')
call s:HL('LspCxxHlSymClass',          'dirtyblonde', '', 'italic')
call s:HL('LspCxxHlSymTemplateParameter', 'saltwatertaffy', '', 'bold')

call s:HL('Type', 'taffy', '', 'bold')
...
call s:HL('StorageClass', 'taffy', '', 'bold')
call s:HL('Structure', 'taffy', '', 'bold')
call s:HL('Typedef', 'dress', '', 'none')

" Make try/catch blocks stand out.
call s:HL('Exception', 'lime', '', 'bold')

" Misc
call s:HL('Error',  'vaffy',   'snow', 'bold')
